...
const Footer = () => {
    return (
        <div className='lg:my-24 sm:my-5'>
            <footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
                <div class="grid grid-flow-col gap-4">
                    <a href='/' class="link link-hover">Home</a>
                    <a href='/completedtask' class="link link-hover">Completed Tasks</a>
                    <a href='/todo' class="link link-hover">To Do</a>
                    <a href='/calander' class="link link-hover">Calendar</a>
                </div>
                <div>
                    <div class="grid grid-flow-col gap-4">
